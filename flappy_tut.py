...
BG_IMG = pygame.transform.scale(pygame.image.load(os.path.join("imgs", "bg.png")), (500,700))
...
class Bird:
    ...
    def move(self):
        ...
        # moving down for more than 16px:
        if d >= 16:
            d = 16
...
class Pipe:
    ...
    def set_height(self):
        # this is the bottom of the top pipe
        self.height = random.randrange(50, 450)
        # this is actually the y position of the top of tho top pipe
...
# this draws both, the top and the bottom of the pipe
    def draw(self, win):
...
def main(genomes, config):
    ...
    while run:
        ...
        for x, bird in enumerate(birds):
            if bird.y + bird.image.get_height() > 670 or bird.y < 0:
                birds.pop(x)
                nets.pop(x)
                ge.pop(x)
